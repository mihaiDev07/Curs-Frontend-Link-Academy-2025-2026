    ...
    products.forEach(function (product) {
        ...
        <div class="card mb-30"><a class="card-img-tiles" href="#" data-abc="true">
            ...
            <div class="card-body text-center">
                <h4 class="card-title">${product.name} ${product.category ? product.category : ''}</h4>
                <p class="text-muted">Starting from ${product.price}</p>
                <a class="btn btn-outline-primary btn-sm" href="product.html?id=${product.id}" data-abc="true">View Product</a>
            </div>
        </div>
    </div>
       `;
